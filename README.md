...
- Live run proof receipts with one-click Verify, automatic Live Check probes, Runtime Output tails in Ship Briefs, Proof Snapshot PNGs, Snapshot Compare, project, command, URL, inspectable touched files, copyable verification text, and one-click Ship Brief handoffs.
