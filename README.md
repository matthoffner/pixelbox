...
- Live run proof receipts with Live Check probes, project, command, URL, inspectable touched files, copyable verification text, and one-click Ship Brief handoffs.
